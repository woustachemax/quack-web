    ...
    openai: (
      <div className="space-y-6">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h3 className={`text-xl font-semibold ${isDark ? 'text-stone-200' : 'text-stone-700'}`}>Model Used</h3>
            <div className={`${isDark ? 'bg-stone-800/50 border-stone-800' : 'bg-stone-100/50 border-stone-300'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-sm`}>
                ...
                <span className={`${isDark ? 'text-stone-500' : 'text-stone-600'} ml-2`}>- Optimized for speed and cost</span>
              </p>
            </div>
          </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-stone-800/50 border-stone-800' : 'bg-stone-100/50 border-stone-300'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-sm`}>
                <span className={`${isDark ? 'text-yellow-400' : 'text-yellow-600'} font-mono`}>claude-3-5-sonnet-20241022</span>
                <span className={`${isDark ? 'text-stone-500' : 'text-stone-600'} ml-2`}>- Latest Sonnet model</span>
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-stone-800/50 border-stone-800' : 'bg-stone-100/50 border-stone-300'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-sm`}>
                ...
                <span className={`${isDark ? 'text-stone-500' : 'text-stone-600'} ml-2`}>- Fast and efficient</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-blue-400/10 border-blue-400/30' : 'bg-blue-400/20 border-blue-500/40'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-blue-300' : 'text-blue-700'} text-sm font-semibold`}>💡 Local Embeddings Only</p>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-xs mt-2`}>
                QuackStack uses <span className={`font-semibold ${isDark ? 'text-blue-300' : 'text-blue-700'}`}>local embeddings</span> to index your code on your machine. No separate embedding API needed! Gemini is only used to generate answers from the code snippets we find.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-stone-800/50 border-stone-800' : 'bg-stone-100/50 border-stone-300'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-sm`}>
                ...
                <span className={`${isDark ? 'text-stone-500' : 'text-stone-600'} ml-2`}>- Optimized for coding tasks</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-blue-400/10 border-blue-400/30' : 'bg-blue-400/20 border-blue-500/40'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-blue-300' : 'text-blue-700'} text-sm font-semibold`}>💡 Local Embeddings Only</p>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-xs mt-2`}>
                QuackStack uses <span className={`font-semibold ${isDark ? 'text-blue-300' : 'text-blue-700'}`}>local embeddings</span> to index your code on your machine. No separate embedding API needed! DeepSeek is only used to generate answers from the code snippets we find.
              </p>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-stone-800/50 border-stone-800' : 'bg-stone-100/50 border-stone-300'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-sm`}>
                ...
                <span className={`${isDark ? 'text-stone-500' : 'text-stone-600'} ml-2`}>- Their most capable model</span>
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className={`${isDark ? 'bg-blue-400/10 border-blue-400/30' : 'bg-blue-400/20 border-blue-500/40'} border rounded-lg p-4`}>
              <p className={`${isDark ? 'text-blue-300' : 'text-blue-700'} text-sm font-semibold`}>💡 Local Embeddings Only</p>
              <p className={`${isDark ? 'text-stone-300' : 'text-stone-700'} text-xs mt-2`}>
                QuackStack uses <span className={`font-semibold ${isDark ? 'text-blue-300' : 'text-blue-700'}`}>local embeddings</span> to index your code on your machine. No separate embedding API needed! Mistral is only used to generate answers from the code snippets we find.
              </p>
            </div>
          </div>
